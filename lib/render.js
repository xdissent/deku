...
function render (element, container, opts) {
  ...
  /**
   * Get the virtual element type as a string
   *
   * @param {Object} vnode
   *
   * @return {String}
   */
  function elementType (vnode) {
    if (typeof vnode === 'string' || typeof vnode === 'number' || typeof vnode === 'boolean') return 'text'
    if (typeof vnode.type === 'string') return 'element'
    return 'component'
  }
  ...
  function toNativeComponent (entityId, path, vnode) {
    ...
    var child = new Entity(vnode.type, props, entities[entityId])
  ...
  function diffNode (path, entityId, prev, next, el) {
    ...
    var prevType = elementType(prev)
    var nextType = elementType(next)
...
function Entity (component, props, owner) {
  owner = owner || {id: rootId}

  this.id = uid()
  this.ownerId = owner.id
  this.component = component
  this.staticContext = owner.staticContext || {}
  if (component.statics) this.staticContext = assign({}, this.staticContext, this.component.statics)
  this.context = {}
  this.context.id = this.id;
  this.context.props = defaults(
    props || {},
    component.defaultProps || {},
    pickMap(this.component.dependencies || {}, this.staticContext)
  )
